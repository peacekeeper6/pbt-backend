...
//         List<Budgeting> findBudgeting = budgetingRepository.findAllByUserId(userId); //we want to get the budgeting object input by userId
//         List<Income> findIncome = incomeRepository.findAllByUserId(userId);
//         List<Expenses> findExpenses = expensesRepository.findAllByUserId(userId);
